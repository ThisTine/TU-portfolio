    ...
    return (
      <div className="page" style={{background:"url(/img/p4.jpg)",backgroundSize:"cover",backgroundAttachment:"center"}}>
        ...
        <SmallPJ pjimg="yearbook" framework={['nextjs','react']}  url="yearbook.thistine.com/" twobytwo={true}>
            Yearbook เว็บทำเนียบรุ่นรองผู้อำนวยการสถานศึกษาสังกัดสำนักงานศึกษาธิการจังหวัดฉะเชิงเทราประจำปี 2563 โดยใช้ข้อมูลจาก google form เป็นฐานข้อมูลผ่าน google sheet
        </SmallPJ>
        <SmallPJ pjimg="ourop" framework={['nextjs','react']} url="thistine.com/ouropinions/" framework={['react']} twobytwo={true}>
        เว็บไซต์สำหรับแสดง/รับฟังความคิดเห็น ภายในโรงเรียนโดยเรียกข้อมูลจาก google form ในรูป
        ...
        Pinkcheer - แอพพลิเคชั่นซ้อมเชียร์กีฬาสีในระบบ online ลดการใช้กระดาษและสามารถใช้งานซ้อมเชียร์โดยระบบ realtime ได้
        </SmallPJ>

        <SmallPJ pjimg="wallet" framework={['react']}  url="pinkwallet.thistine.com" twobytwo={true}>
        Pinkwallet - แอพพลิเคชั่นรายงานงบประมานการใช้จ่ายของการทำงานในโครงการต่าง ๆ แบบ realtime
        </SmallPJ>
