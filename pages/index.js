export default function Home() {
  const weburl = "s.thistine.com/tu";
  return (
      ...
      <div className="bottom" style={{paddingBottom:"70px"}}>
        ...
        <div className="uniname">
          ...
          <div className="uniname-top">
            <p className="label uniname-label-name">TU</p>
            <p className="label uniname-label-name">มหาวิทยาลัยธรรมศาสตร์</p>
          </div>
            <p className="label uniname-label">สาขาวิทยาการคอมพิวเตอร์</p>
          </div>
        </div>
